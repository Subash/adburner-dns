...
const config = {
  ...
  httpsRemoteAddressFallback: process.env.HTTPS_REMOTE_ADDRESS_FALLBACK || 'https://dns.google.com/resolve',
  udpRemoteAddress: process.env.UDP_REMOTE_ADDRESS || '1.1.1.1',
  udpRemoteAddressFallback: process.env.UDP_REMOTE_ADDRESS_FALLBACK || '8.8.8.8',
  useFallbackAddress: !(process.env.USE_FALLBACK_ADDRESS == 'false'), //Use fallback address by default
